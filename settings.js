...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=ezYwWI5A#N3cB1Iwg67oKVh5cfBoTAM-0EF3ghi_EFLuoROBN9S8' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '9473737373,94717202954' : process.env.SUDO,
SESSION_NAME: process.env.PORT === undefined ? "nadil" : process.env.SESSION_NAME,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello , I am alive now!!•━━• • ʀʙ 亗 Ᏼᴜᴅᴅʏㅤ⸙ ㅤ • •━━•*" : process.env.ALIVE_MSG,
